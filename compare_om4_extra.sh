...
benchmark_dir=/gpfs/f5/gfdl_f/scratch/Mikyung.Lee/OM4_extra/main_0
test_dir=/gpfs/f5/gfdl_f/scratch/Mikyung.Lee/OM4_extra/$1"_0"

expts=( MOM6_GOLD_SIS2_bergs MOM6_GOLD_SIS2_generics MOM6_GOLD_SIS2_generics_ens2
        MOM6_SIS2_Baltic MOM6_SIS2_bergs_cgrid MOM6_SIS2_cgrid )

prod=ncrc5.intel23-repro

logfile=NCCMP_om4_extra
